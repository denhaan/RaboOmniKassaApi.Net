...
namespace RaboOmniKassaApi.Tests.Models.Request
{
    ...
    public class MerchantOrderRequestTest
    {
        ...
        public void testJsonEncoding_withoutOptionalFields()
        {
            ...
            merchantOrderRequest.Timestamp = CreateTimeStamp();
            ...
            var expectedJson = "{\"signature\":\"" + merchantOrderRequest.Signature + "\",\"merchantOrderId\":\"100\",\"amount\":{\"currency\":\"EUR\",\"amount\":9999},\"merchantReturnURL\":\"http:\\/\\/localhost\\/\",\"timestamp\":\"" + merchantOrderRequest.TimestampRaw + "\"}";
        ...
        public void testJsonEncoding_allFields()
        {
            ...
            merchantOrderRequest.Timestamp = CreateTimeStamp();
            SetSignature(merchantOrderRequest);
            //var expectedJson = "{\"signature\":\"0712c403c89ae92f7531aea31280eb517e274c93c2196e905415407c0dc4bd71e7f0048720ae70d00303da8551485c6444c0f5ddf215ebeb7af4e34580a1af61\",\"merchantOrderId\":\"100\",\"description\":\"Order ID: 100\",\"orderItems\":[{\"id\":\"15\",\"name\":\"Name\",\"description\":\"Description\",\"quantity\":1,\"amount\":{\"currency\":\"EUR\",\"amount\":100},\"tax\":{\"currency\":\"EUR\",\"amount\":50},\"category\":1,\"vatCategory\":1}],\"amount\":{\"currency\":\"EUR\",\"amount\":9999},\"shippingDetail\":{\"firstName\":\"Jan\",\"middleName\":\"van\",\"lastName\":\"Veen\",\"street\":\"Voorbeeldstraat\",\"houseNumber\":\"5\",\"houseNumberAddition\":\"a\",\"postalCode\":\"1234AB\",\"city\":\"Haarlem\",\"countryCode\":\"NL\"},\"billingDetail\":{\"firstName\":\"Piet\",\"middleName\":\"van der\",\"lastName\":\"Stoel\",\"street\":\"Dorpsstraat\",\"houseNumber\":\"9\",\"houseNumberAddition\":\"rood\",\"postalCode\":\"4321YZ\",\"city\":\"Bennebroek\",\"countryCode\":\"NL\"},\"customerInformation\":{\"emailAddress\":\"jan.van.veen@gmail.com\",\"dateOfBirth\":\"1987-03-20T00:00:00+01:00\",\"gender\":\"M\",\"initials\":\"J.M.\",\"telephoneNumber\":\"0204971111\"},\"language\":\"NL\",\"merchantReturnURL\":\"http:\\/\\/localhost\\/\",\"paymentBrand\":0,\"paymentBrandForce\":0,\"timestamp\":\"2016-12-21T14:13:56+01:00\"}";
            var expectedJson = "{\"signature\":\"" + merchantOrderRequest.Signature + "\",\"merchantOrderId\":\"100\",\"description\":\"Order ID: 100\",\"orderItems\":[{\"id\":\"15\",\"name\":\"Name\",\"description\":\"Description\",\"quantity\":1,\"amount\":{\"currency\":\"EUR\",\"amount\":100},\"tax\":{\"currency\":\"EUR\",\"amount\":50},\"category\":1,\"vatCategory\":1}],\"amount\":{\"currency\":\"EUR\",\"amount\":9999},\"shippingDetail\":{\"firstName\":\"Jan\",\"middleName\":\"van\",\"lastName\":\"Veen\",\"street\":\"Voorbeeldstraat\",\"houseNumber\":\"5\",\"houseNumberAddition\":\"a\",\"postalCode\":\"1234AB\",\"city\":\"Haarlem\",\"countryCode\":\"NL\"},\"billingDetail\":{\"firstName\":\"Piet\",\"middleName\":\"van der\",\"lastName\":\"Stoel\",\"street\":\"Dorpsstraat\",\"houseNumber\":\"9\",\"houseNumberAddition\":\"rood\",\"postalCode\":\"4321YZ\",\"city\":\"Bennebroek\",\"countryCode\":\"NL\"},\"customerInformation\":{\"emailAddress\":\"jan.van.veen@gmail.com\",\"dateOfBirth\":\"" + merchantOrderRequest.CustomerInformation.DateOfBirthRaw + "\",\"gender\":\"M\",\"initials\":\"J.M.\",\"telephoneNumber\":\"0204971111\"},\"language\":\"NL\",\"merchantReturnURL\":\"http:\\/\\/localhost\\/\",\"paymentBrand\":0,\"paymentBrandForce\":0,\"timestamp\":\"" + merchantOrderRequest.TimestampRaw + "\"}";
            var actualJson = JsonHelper.Serialize(merchantOrderRequest);
        ...
        public void testJsonEncoding_withOrderItemsWithoutOptionalFields()
        {
            ...
            merchantOrderRequest.Timestamp = CreateTimeStamp();
            SetSignature(merchantOrderRequest);
            //var expectedJson = "{\"signature\":\"765b966304f7e6d4f4c1dd5b684175a7f193eb282c27462d6e1c2c170d7d0db84c0136d06082bf4d62f12bbabb8a54abc64c2106016f041ec1c0ef2e599ac659\",\"merchantOrderId\":\"100\",\"orderItems\":[{\"name\":\"Name\",\"description\":\"Description\",\"quantity\":1,\"amount\":{\"currency\":\"EUR\",\"amount\":100},\"category\":1}],\"amount\":{\"currency\":\"EUR\",\"amount\":9999},\"merchantReturnURL\":\"http:\\/\\/localhost\\/\",\"timestamp\":\"2016-12-21T14:13:56+01:00\"}";
            var expectedJson = "{\"signature\":\"" + merchantOrderRequest.Signature + "\",\"merchantOrderId\":\"100\",\"orderItems\":[{\"name\":\"Name\",\"description\":\"Description\",\"quantity\":1,\"amount\":{\"currency\":\"EUR\",\"amount\":100},\"category\":1}],\"amount\":{\"currency\":\"EUR\",\"amount\":9999},\"merchantReturnURL\":\"http:\\/\\/localhost\\/\",\"timestamp\":\"" + merchantOrderRequest.TimestampRaw + "\"}";
            var actualJson = JsonHelper.Serialize(merchantOrderRequest);
        ...
        public void testJsonEncoding_withShippingDetailsWithoutOptionalFields()
        {
            ...
            var expectedJson = "{\"signature\":\"" + merchantOrderRequest.Signature + "\",\"merchantOrderId\":\"100\",\"amount\":{\"currency\":\"EUR\",\"amount\":9999},\"shippingDetail\":{\"firstName\":\"Jan\",\"middleName\":\"van\",\"lastName\":\"Veen\",\"street\":\"Voorbeeldstraat\",\"houseNumber\":\"5\",\"houseNumberAddition\":\"a\",\"postalCode\":\"1234AB\",\"city\":\"Haarlem\",\"countryCode\":\"NL\"},\"merchantReturnURL\":\"http:\\/\\/localhost\\/\",\"timestamp\":\"" + merchantOrderRequest.TimestampRaw + "\"}";
            var actualJson = JsonHelper.Serialize(merchantOrderRequest);
        ...
        public void testJsonEncoding_withPaymentBrandButWithoutOtherOptionalFields()
        {
            ...
            merchantOrderRequest.Timestamp = CreateTimeStamp();
            SetSignature(merchantOrderRequest);
            //var expectedJson = "{\"signature\":\"7b847bba5c597d27028463f771109305c9c546f8702463f9a253b7be1b8edae98223bf272d1beba21e7a35015b93bf3dd9b205cd8b73d6a024a096945ecc4f34\",\"merchantOrderId\":\"100\",\"amount\":{\"currency\":\"EUR\",\"amount\":9999},\"merchantReturnURL\":\"http:\\/\\/localhost\\/\",\"paymentBrand\":0,\"paymentBrandForce\":0,\"timestamp\":\"2016-12-21T14:13:56+01:00\"}";
            var expectedJson = "{\"signature\":\"" + merchantOrderRequest.Signature + "\",\"merchantOrderId\":\"100\",\"amount\":{\"currency\":\"EUR\",\"amount\":9999},\"merchantReturnURL\":\"http:\\/\\/localhost\\/\",\"paymentBrand\":0,\"paymentBrandForce\":0,\"timestamp\":\"" + merchantOrderRequest.TimestampRaw + "\"}";
            var actualJson = JsonHelper.Serialize(merchantOrderRequest);
        ...
        {
            return new DateTime(2016, 12, 21, 14, 13, 56);
        }
